              ...
              {guideStats.map(g => (
                <div key={g.id} className="aurelia-card p-6 border border-white/5 hover:border-gold/30 transition-all group">
                  ...
                  <button 
                    ...
                    className="w-full mt-6 py-3 bg-white/5 border border-white/10 rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-white/10 hover:border-gold/30 transition-all flex items-center justify-center gap-2 group/btn"
                  >
